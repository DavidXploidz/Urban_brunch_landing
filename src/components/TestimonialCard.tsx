  ...
  return (
    <div className="space-y-4 bg-cafe-50 rounded-xl p-2 md:p-3 lg:p-4 shadow-xs">
        ...
        <div className="flex items-center gap-2 pl-10">
            <img className="rounded-full object-cover w-16 h-16" src={testimonial.image || "./images/user_default.png"} alt={`profile image ${testimonial.name}`} onError={(e) => (e.currentTarget.src = "./images/user_default.png")} />
